...
export default async function AdminTasacionesPage({
  ...
  const [features, items] = await Promise.all([
    getInmoFeatures(),
    getTasaciones(filterEstado ? { estado: filterEstado } : undefined),
  ]);
  ...
  return (
    <div className=”px-6 py-10 md:px-10 md:py-12”>
      ...
      <FeatureGate enabled={features.tasaciones ?? false} message=”Las Tasaciones están disponibles en el plan Pro”>
        {items.length === 0 ? (
